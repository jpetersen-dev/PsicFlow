    ...
    <>
                ...
                >
                  <div className="space-y-3">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      {/* Dejar reseña button for completed sessions */}
                      {sess.status_session === 'Completa' && !isCancelled && (
                        reviewedSessionIds.includes(sess.professional_id) ? (
                          ...
                          <button
                            ...
                            className="text-[10px] font-bold text-accent-primary hover:text-accent-hover bg-accent-primary/10 hover:bg-accent-primary/20 px-2.5 py-1 rounded transition-all cursor-pointer border-0"
                          >
                            Dejar Reseña
                          </button>
                        )
      ...
      {showReviewModal && selectedSessionForReview && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-white rounded-2xl p-6 sm:p-8 max-w-md w-full border border-border-color shadow-2xl relative space-y-5 animate-in fade-in zoom-in-95 duration-200">
            <button 
