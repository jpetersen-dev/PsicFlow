...
export const NewPatientModal: React.FC<NewPatientModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const generateFichaId = async () => {
    ...
    // Get count of patients registered today to increment daily XX counter
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Generate Ficha ID number YYMMDDXX
    ...
    <div className="fixed inset-0 bg-slate-950/70 backdrop-blur-sm flex items-center justify-center z-50 p-4 overflow-y-auto">
      <div className="bg-slate-900 border border-slate-800 w-full max-w-4xl rounded-2xl shadow-2xl flex flex-col max-h-[90vh]">
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 space-y-6">
          {error && (
            <div className="bg-rose-500/15 border border-rose-500/30 p-4 rounded-xl flex items-center gap-3 text-sm text-rose-400">
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-emerald-400 border-b border-slate-850 pb-1">1. Identificación Core</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Nombre Completo *</label>
                <input 
                  type="text" required name="full_name" value={formData.full_name} onChange={handleChange}
                  className="w-full bg-slate-950 border border-slate-800 rounded-lg px-3 py-2 text-sm text-slate-100 focus:border-emerald-500 focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">RUT / Identificación *</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Fecha Nacimiento *</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Género</label>
                <select 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Estado Civil</label>
                <select 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Estado Clínico</label>
                <select 
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-emerald-400 border-b border-slate-850 pb-1">2. Información Personal y Educacional</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Nivel Escolaridad</label>
                <select 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Estado / Curso Escolaridad</label>
                <select 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Institución Educacional</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Ocupación / Profesión</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Sistema de Salud</label>
                <select 
          ...
          {/* Section 3: Datos de Contacto y Emergencia */}
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-emerald-400 border-b border-slate-850 pb-1">3. Datos de Contacto y Ubicación</h3>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Teléfono de Contacto</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Dirección (Calle y N°)</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Comuna</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Región</label>
                <input 
          ...
          <div className="space-y-4">
            <h3 className="text-sm font-semibold text-emerald-400 border-b border-slate-850 pb-1">4. Contacto de Emergencia</h3>
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
              <div className="md:col-span-2">
                <label className="block text-xs text-slate-400 mb-1 font-medium">Nombre Contacto</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Parentesco</label>
                <input 
              ...
              <div>
                <label className="block text-xs text-slate-400 mb-1 font-medium">Teléfono Emergencia</label>
                <input 
              ...
              <div className="md:col-span-2">
                <label className="block text-xs text-slate-400 mb-1 font-medium">Email Emergencia</label>
                <input 
        ...
        <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-800 bg-slate-900/50">
          <button 
            ...
            className="px-4 py-2 border border-slate-800 hover:bg-slate-800 text-sm font-semibold rounded-lg text-slate-300 transition-all disabled:opacity-50"
          >
            Cancelar
          </button>
          <button 
            onClick={handleSubmit} disabled={loading}
            className="bg-emerald-500 hover:bg-emerald-600 text-slate-950 font-bold px-4 py-2 rounded-lg flex items-center gap-2 text-sm transition-all disabled:opacity-50"
          >
